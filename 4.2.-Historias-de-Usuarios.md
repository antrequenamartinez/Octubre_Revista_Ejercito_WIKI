...
## HU.04 – Clasificar artículo (Artículo/Sección Fija)
...
**Como**: Dirección
**Quiero**: buscar artículos por **título, autor, estado, sección y fechas**
**Para**: acceder rápidamente a la información requerida
...
**Como**: Dirección
**Quiero**: buscar autores por **nombre, email, teléfono, etc**
...
* KPIs mínimos:
  ...
  * Nº artículos por estado y por sección.
  * Nº evaluaciones pendientes / realizadas.
...
**Para**: habilitar su acceso (vía infraestructura BBDD/DICODEF)
...
* Estado inicial **ALTA**, con gestión de recuperación de credenciales (para usuarios de BBDD).
...
* No se gestiona contraseña para usuarios DICODEF.
